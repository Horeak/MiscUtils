...
public class BlockRegister {
    ...
    public void RegisterIcons(){
        for(Map.Entry<String, Block> entities : map.entrySet()){
            Minecraft.getMinecraft().getRenderItem().getItemModelMesher().register(Item.getItemFromBlock(entities.getValue()), 0, new ModelResourceLocation(Id.toLowerCase() + ":" + entities.getKey(), "inventory"));
        }
    }
}
