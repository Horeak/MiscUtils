...
public class GuideRecipeButton  extends GuiButton {
    ...
    public GuideRecipeButton(int p_i1020_1_, int p_i1020_2_, int p_i1020_3_) {
    ...
    public void drawButton(Minecraft mc, int x, int y)
    {
        ...
        this.mouseDragged(mc, x, y);
            ...
            drawRect(xPosition, yPosition, xPosition + 18, yPosition + 18, new Color(119, 119, 119).getRGB());
